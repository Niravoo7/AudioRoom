...
UpcomingRoomModel upcomingRoomModelFromJson(String str) => UpcomingRoomModel.fromJson(json.decode(str));

String upcomingRoomModelToJson(UpcomingRoomModel data) => json.encode(data.toJson());

class UpcomingRoomModel {
  UpcomingRoomModel({
    this.moderator,
    this.broadcaster,
    this.audiance,
  ...
  factory UpcomingRoomModel.fromJson(Map<String, dynamic> json) => UpcomingRoomModel(
