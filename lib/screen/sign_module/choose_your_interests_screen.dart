...
import 'package:audioroom/screen/sign_module/invite_people_screen.dart';
...
class _ChooseYourInterestsScreenState extends State<ChooseYourInterestsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: CommonAppBar(context, "Choose your interests", true, true, () {
          ...
          Navigator.push(
              context, NavigatePageRoute(context, InvitePeopleScreen()));
        }),
        body: SafeArea(
            child: Container(
                              ...
                              return ListView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    return Container(
                                      ...
                                      children: [
                                        TextWidget(
                                            interestModelTemp.categoryTitle,
                                            color: AppConstants.clrBlack,
                                            fontSize:
  ...
  void submitEvent() {
    /*Navigator.push(
        context, NavigatePageRoute(context, FollowSomePeopleScreen()));*/
    Navigator.push(context, NavigatePageRoute(context, InvitePeopleScreen()));
  }
}
